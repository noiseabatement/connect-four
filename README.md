Simple connect four game. There are two colors which represents each player. EventListener added according to columns. When a player clicks a column, function checks if
